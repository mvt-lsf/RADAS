...
if __name__ == '__main__':
	...
	source_DAS=False
	time_stamp_DAS=False #regula la creacion de log para los ts reportados por el DAS
	...
	mail_send=False#regula el envio de mails
	...
	if alarmas_switch:
		...
		bin_inicio=1680
		bin_fin=5100
		umbrales={15:0.8,20:0.75,30:0.7,40:0.65,50:0.625}#10:0.6
		ventana_alarma=15
	...
	plot_anim=func_plot.plot_setup(save_figure,buffer_q,bins_plot,delta_x,plots_per_second)
